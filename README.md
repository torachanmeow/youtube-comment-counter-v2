...
YouTubeライブ配信のチャットをリアルタイムで取得し、スーパーチャット・メンバーシップ（加入/ギフト・継続記念）・高評価・キーワード出現回数を集計してポイント化するツール。OBS用ウィンドウで配信画面にポイントを表示できます。
...
- **ポイント計算** — 高評価・スパチャ・スパステ・メンバーシップ（加入/ギフト）・メンバー継続記念・キーワードに倍率を設定し、合計ポイントを表示
...
GitHub Pages の `gh-pages` ブランチにビルド＋デプロイされます。
